// Containers
const profitsDisplay = document.getElementById('profitsDisplay');
...
// Functions
function updateProfits() {       // Update profits display
    profitsDisplay.textContent = `Profits: $${profits}`;
}
